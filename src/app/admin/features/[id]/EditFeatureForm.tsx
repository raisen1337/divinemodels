...
export default function EditFeatureForm({ feature }: { feature: Feature }) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            // Redirect to features list page after a short delay
            setTimeout(() => {
                router.push('/admin/features?success=true&action=updated');
                router.refresh();
            }, 1500);
        } catch (err: any) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            // Redirect to the features list page
            router.push('/admin/features?success=true&action=deleted');
            router.refresh();
        } catch (err: any) {
        ...
        <div className="max-w-3xl mx-auto pb-12">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Edit Feature: {feature.name}</h1>
                </div>
                <div>
                    <button
                        type="button"
                        ...
                        disabled={feature._count.models > 0}
                        title={feature._count.models > 0 ? "Cannot delete feature with associated models" : "Delete feature"}
                    >
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-yellow-700">
                                This feature is currently used by {feature._count.models} model{feature._count.models === 1 ? '' : 's'}.
                                You cannot delete it until all models are removed from this feature.
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Are you sure you want to delete the feature "{feature.name}"? This action cannot be undone.
                                        </p>
