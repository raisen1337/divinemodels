            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-6">
                <div>
                    ...
                    <input
                        ...
                        required
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 transition-colors font-mono text-sm"
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-gold-600 to-gold-700 text-white font-medium rounded-lg hover:from-gold-700 hover:to-gold-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                    >
                        {loading ? (
                            <>
